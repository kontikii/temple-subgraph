...
export class TempleERC20Token extends ethereum.SmartContract {
  static bind(address: Address): TempleERC20Token {
    return new TempleERC20Token("TempleERC20Token", address);
  }

  CAN_MINT(): Bytes {
    let result = super.call("CAN_MINT", "CAN_MINT():(bytes32)", []);

    return result[0].toBytes();
  }

  try_CAN_MINT(): ethereum.CallResult<Bytes> {
    let result = super.tryCall("CAN_MINT", "CAN_MINT():(bytes32)", []);
    if (result.reverted) {
